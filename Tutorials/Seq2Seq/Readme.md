...
--logdir runs is used because it will directly check for runs folder. if you saved it with some other folder name, use that name instead of runs, to see it. when the server
